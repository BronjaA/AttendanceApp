...
class DodajPredavanje extends Component {
  constructor(props){
    super(props);
    this.state = {
      jwt: '',
  ...
  registrujPredavanje(){
    axios.post("https://attendance-app997.herokuapp.com/api/activities/createLecture", {subject: this.props.route.params.subject._id, type: 'Predavanje', date: this.sviDatumi, aptFrom: this.intervalOd, aptTo: this.intervalDo, location: this.state.lokacija})
    .then((response) => {
      Alert.alert('Uspeh!', 'Uspešno ste dodali predavanja!');
    ...
    return (
        <View style={styles.container}>
          <TouchableOpacity onPress={() => console.log(this.sviDatumi)}>
            <Text style={{fontSize: 19, marginTop: 20, marginLeft: 20, marginBottom: 7, color: '#009387'}}>Dodaj predavanje </Text>
          </TouchableOpacity>
          ...
          :
            ...
            }} style={{marginTop: 100, borderWidth: 2, borderColor: '#009387', padding: 10, marginHorizontal: 20}}>Dodaj predmet</SubjectBtn>
          }
